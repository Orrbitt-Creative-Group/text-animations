...
if (input instanceof HTMLInputElement) darkModeInput(input);
function animateIn(el, text) {
    new (0, _scrollTrigger.ScrollTrigger)({
        trigger: el,
        start: "50% 40%",
        onEnter: ()=>{
...
function animateText(el) {
    ...
    title.words.forEach((word, i)=>{
        ...
        word.style.setProperty("--word-index", `${++word_index}`);
    });
...
},{"gsap/SplitText":"54FYr","gsap":"9opQi","gsap/ScrollTrigger":"AMvUX"}],"54FYr":[function(require,module,exports) {
/*!
 * SplitText: 3.12.2
 * https://greensock.com
 *
...
},{}],"9opQi":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3dkiX"}],"kBkyZ":[function(require,module,exports) {
/*!
 * CSSPlugin 3.12.2
 * https://greensock.com
 *
